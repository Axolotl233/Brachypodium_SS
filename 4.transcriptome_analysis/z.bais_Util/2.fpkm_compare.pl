...
my $h_dir = getcwd();
my $fpkm = "/data/01/user112/project/Brachypodium/07.evo/07.bhyb_subgenome_bias/1.gene_expression/0.data/Bhyb.tpm.txt";
#my $fpkm = "/data/01/user112/project/Brachypodium/09.trans/bhyb/02.stringtie/Bhyb.tpm.txt";
my $sample_lst = "/data/01/user112/project/Brachypodium/07.evo/07.bhyb_subgenome_bias/1.gene_expression/0.data/Sample.txt";
my $genepair_dir = "/data/01/user112/project/Brachypodium/07.evo/07.bhyb_subgenome_bias/1.gene_expression/1.gene_pair";
my @m = qw/CL2 TL2/;
my %f;
open IN,'<',"$fpkm" or die "$!";
...
my @fs = sort {$a cmp $b} grep {/genepair.txt/} `find /data/01/user112/project/Brachypodium/07.evo/07.bhyb_subgenome_bias/1.gene_expression/1.gene_pair`;
